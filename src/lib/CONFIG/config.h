...
public:
    ...
    uint8_t GetVtxChannelAux() const { return m_model->ptrStartChannel; }
    uint8_t GetVtxBandAux() const { return m_model->ptrEnableChannel; }
    ...
    void SetVtxChannelAux(uint8_t ptrStartChannel);
    void SetVtxBandAux(uint8_t ptrEnableChannel);
